...
public class LoginFrame extends JFrame implements SocketSetting, VersionProperty{
	...
	private final JFormattedTextField accountInput = new JFormattedTextField();
	private final JFormattedTextField passwordInput = new JFormattedTextField();
	...
	public LoginFrame() throws IOException{
		Socket socket = new Socket("27.147.3.116", 5200);
		...
		//Title init
		JLabel title = new JLabel("Cz\u7BA1\u7406\u7CFB\u7D71\u767B\u5165");
		...
		//InfoLabel init
		JLabel infoLabel = new JLabel("<html>\u8ACB\u8F38\u5165\u60A8\u7684\u5E33\u865F\u53CA\u5BC6\u78BC\u4E14\u767B\u5165\uFF0C\u57FA\u65BC\u5B89\u5168\u6027\u554F\u984C\uFF0C\u767B\u5165\u6642\u9084\u8981\u591A\u586B\u5165\u9A57\u8B49\u78BC\u9078\u9805</html>");
		...
		//LoginBtm init
		Button loginBtm = new Button("\u767B\u5165");
		//If get clicked event, run the override method
		loginBtm.addActionListener(e -> {
			String account = accountInput.getText();
			String password = passwordInput.getText();
			login(account, password);
		});
		loginBtm.setFont(new Font("\u5fae\u8edf\u6b63\u9ed1\u9ad4", Font.PLAIN, 25));
		...
		//registerLabel init
		JLabel registerLabel = new JLabel("\u82E5\u6C92\u6709\u5E33\u865F\uFF0C\u9EDE\u6211\u524D\u5F80\u8A3B\u518A");
